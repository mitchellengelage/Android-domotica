...
public class LedstripRemoteControlFragment extends Fragment {
    ...
    public static LedstripRemoteControlFragment newInstance(String param1, String param2) {
        LedstripRemoteControlFragment fragment = new LedstripRemoteControlFragment();
    ...
    public LedstripRemoteControlFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View InputFragmentView = inflater.inflate(R.layout.fragment_ledstripremotecontrol, container, false);
